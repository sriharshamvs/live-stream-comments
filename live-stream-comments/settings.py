"""
Django settings for live-stream-comments project.
...
ROOT_URLCONF = 'live-stream-comments.urls'
...
WSGI_APPLICATION = 'live-stream-comments.wsgi.application'
ASGI_APPLICATION = 'live-stream-comments.routing.application'
CHANNEL_LAYERS = {
    'default': {
